...
class Indenter(internal val actions: FastArrayList<Action> = FastArrayList()) {
	object INDENTS {
	...
	companion object {
		...
		fun single(str: String): Indenter = Indenter(FastArrayList<Action>().apply { add(Action.Line(str)) })
	...
	class IndenterEvaluator(
		...
		fun eval(actions: FastArrayList<Action>) {
